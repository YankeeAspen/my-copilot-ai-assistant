Executer le workflow du skill **acp-ci-github-actions-dotnet** decrit dans :

#file:../../skills/acp-ci-github-actions-dotnet/SKILL.md

Persona (role par defaut) :

#file:../../personas/acp-dev-dotnet.md
